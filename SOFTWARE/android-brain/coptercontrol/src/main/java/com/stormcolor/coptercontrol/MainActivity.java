...
public class MainActivity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		text_rotInfo = (TextView)findViewById(R.id.text_rotInfo);

		app.setRotInfo(text_rotInfo);
	...
	private void initializeUSB() {
		...
		//System.out.println(device.getVendorId()); // 04d8 in hex. 1240 in decimal
		//System.out.println(device.getProductId()); // 003f in hex. 63 in decimal
