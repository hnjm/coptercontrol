...
public class ShaderMaterial_Default {
	...
	private String vertexShaderCode =
            ...
            "void main() {"+
            "	vec4 modelMatrix = transpose(uModelMatrix_Position_Node) * transpose(uModelMatrix_Rotation_Node) * vec4(aPosition.x*uScale, aPosition.y*uScale, aPosition.z*uScale, 1.0);"+
    ...
    private String fragmentShaderCode =
			...
			"		float depthFromTexture = unpack(textureFBLightDepth)+0.005;"+
			...
			"		float ambColor = 0.65;"+
			"		light = min(light+ambColor, 1.0);"+

			"		finalColor = min(vec4(finalColor.rgb*light, finalColor.a), 1.0);"+
            "	}"+
	...
	public ShaderMaterial_Default() {
		...
		uScale = GLES20.glGetUniformLocation(mProgram, "uScale");
